    ...
    <section className="bg-[#f4f0e6] px-[clamp(24px,9vw,140px)] py-30 max-md:py-20">
      <Reveal className="grid grid-cols-[.8fr_1.2fr] gap-[10vw] max-md:grid-cols-1">
        ...
        <div className="max-w-170">
          <Leaf size={30} strokeWidth={1.3} className="mb-8 text-[#e56d3d]" />
          <p className="font-serif text-[clamp(26px,3vw,38px)] leading-tight text-[#18392f]">
          ...
          <div className="mt-9 grid grid-cols-2 gap-8 border-t border-[#18392f]/15 pt-8 text-[13px] leading-7 text-[#61746b] max-md:grid-cols-1">
            <p>
