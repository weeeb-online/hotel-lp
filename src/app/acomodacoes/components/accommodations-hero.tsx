export function AccommodationsHero() {
  return (
    <section className="relative flex min-h-145 items-end bg-[url('https://cf.bstatic.com/xdata/images/hotel/max1024x768/723652655.webp?k=b8cc0d247fbba345a5677ffcaab9471bc0df44f14d8038ad62f972bfcb390348&o=')] bg-cover bg-center px-[clamp(24px,9vw,140px)] pb-20 pt-32 text-white">
      ...
      <div className="relative z-1 max-w-225">
        ...
        <h1 className="font-serif text-[clamp(66px,8vw,112px)] leading-[.78] tracking-[-.04em]">
          Acomodações para
          <br />
